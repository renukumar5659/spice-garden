...
export default function OrderConfirmation() {
  ...
  return (
    <div className="container section-tight">
      <div className="confirmation-card card receipt">
        <div className="confirmation-check">✓</div>
        <h1>Order Confirmed!</h1>
        <p>Thank you — your order has been placed successfully.</p>
        <div className="order-id-chip">Order ID: {order.order_id}</div>
        ...
        <div className="summary-line total"><span>Total Paid</span><span>₹{Number(order.total_amount).toFixed(0)}</span></div>
