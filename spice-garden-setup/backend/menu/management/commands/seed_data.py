...
ITEMS = [
    ...
    ("Starters", "Veg Manchurian",
     ...
     160, True, "hot", "menu_items/images_15.jfif"),
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for cat_name, name, desc, ingredients, price, is_veg, spice, image in ITEMS:
